...
import com.gs.crms.common.exception.HttpRestException;
...
public class LimitIPRequestAspect {
     ...
     */
    @Before("execution(* com.gs.crms.apportion.webapi.controller.*.*(..)) && @annotation(com.gs.crms.common.annotation.LimitIPRequestAnnotation)")
